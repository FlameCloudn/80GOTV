...
def calculate_rating(kills, deaths, rounds_played, adr=None, kast=None, impact=None):
    ...
    # 简化计算
    rating = 0.0073 * kast + 0.3591 * kpr - 0.5329 * dpr + 0.2372 * (impact or 0) + 0.0032 * (adr or 0) + 0.1587
...
def calculate_impact(entry_kills, entry_deaths, multi_kills, clutches_won, rounds_played):
    ...
    impact = (entry_kills * 1.5 - entry_deaths * 0.7 + multi_kills * 0.5 + clutches_won * 2.0) / rounds_played
